 ...
 */
class RubyPanel extends JPanel {

  private ReadOnlyDungeon model;

  RubyPanel(ReadOnlyDungeon model) {
    this.model = model;
  }
  ...
  protected void paintComponent(Graphics g) {
    ...
    Image myPicture = Utils.getImageToDraw("img/ruby.png");
    g.drawImage(myPicture, super.getWidth() / 3,
            super.getHeight() / 3,
            null);
    g.drawString(String.format("You have %d rubies", count),
            super.getWidth() / 5,
            super.getHeight() / 5);
  }
